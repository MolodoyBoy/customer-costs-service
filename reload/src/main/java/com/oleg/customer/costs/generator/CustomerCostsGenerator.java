...
@Component
public class CustomerCostsGenerator implements CustomerCostsBankSource {
    ...
    public CustomerCostsGenerator(DescriptionMappings descriptionMappings,
    ...
    @Override
    public List<CustomerCosts> getCustomerCosts(int userId, int bankId) {
